...
//       2. Method invocation (Implicit binding)
 ...
 //           4.  Constructor invocation (New binding) -
  ...
  // 4) What does .bind do?
      ...
      pretty much creates a new function thats is bound to the object we used .bind on.
...
//returned from the Car function. You'll also need to use the 'this' keyword properly in order to
...
//that will allow for you to call the getYear function with the prius then the mustang objects being the 
